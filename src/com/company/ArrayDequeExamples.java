...
public class ArrayDequeExamples {
    ...
    /*
     ...
     Output: 3
     Explanation: The subarray [3,4,3] has a size of 3,
     and every element is greater than 6 / 3 = 2.
     Note that this is the only valid subarray.

     Algorithm :-
     - ArrayDeque is used a stack.
     - Iterate through all elements of array
     - check if stack top consist of greater element OR
       Last element it means all element to left  are also greater
      It means it can be a valid subArray
     - To check if its valid-
        We need get smallest element *  size of subArray > threshold --> return Valid Subarray
     */
