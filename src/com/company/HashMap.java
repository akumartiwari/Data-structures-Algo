...
public class HashMap {
    ...
    public long[] distance(int[] nums) {
        ...
        Map<Integer, TreeMap<Integer, Long>> freq = new java.util.HashMap<>(); // element, {index, ps of remaining indexes}
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            long left = keys.size() > 1 ? Math.abs(((ind + 1) * i) - indexes.get(i)) : 0;
